...
public class PPGI {
	...
	*/
	...
	public void escreveArquivoRecredenciamento(int ano, String path) throws ErroDeIO {
		...
		try {
			CSVmanager.CSVwriter(content, path, ';', ',');
		} catch (IOException e) {
			throw new ErroDeIO();
		}
	...
	public void escreveArquivoPublicacoes(String path) throws ErroDeIO {
	...
	public void escreveArquivoEstatisticas(String path) throws ErroDeIO {
		ArrayList<String[]> content = new ArrayList<String[]>();
